            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'alivescan', title: __('Alivescan'), formatter: Table.api.formatter.status, custom: {is_scan: 'success', no_scan: 'danger', scan: 'info'},searchList: {is_scan: '已扫描', no_scan: '未扫描', scan: '扫描中'}},
                        {field: 'portscan', title: __('Portscan'), formatter: Table.api.formatter.status, custom: {is_scan: 'success', no_scan: 'danger', scan: 'info'},searchList: {is_scan: '已扫描', no_scan: '未扫描', scan: '扫描中'}},
